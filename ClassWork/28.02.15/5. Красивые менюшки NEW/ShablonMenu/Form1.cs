...
namespace ShablonMenu
{
    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            menuStripEnglish.Renderer = new ToolStripAeroRenderer(ToolbarTheme.MediaToolbar);
            menuStripRussian.Renderer = new ToolStripAeroRenderer(ToolbarTheme.CommunicationsToolbar);
        }
