...
namespace PrintThreePages
{
    class PrintThreePages : Form
    {
        ...
        public PrintThreePages()
        {
            ...
            Menu.MenuItems[0].MenuItems.Add("&Print...", new EventHandler(MenuFilePrintOnClick));
        }
        ...
        void MenuFilePrintOnClick(object obj, EventArgs ea)
        {
            ...
            // Set printer resolution to "draft" (черновой, эскизный уровень)
        ...
        void OnQueryPageSettings(object obj, QueryPageSettingsEventArgs ps)
        {
            if (ps.PageSettings.PrinterSettings.LandscapeAngle != 0)
