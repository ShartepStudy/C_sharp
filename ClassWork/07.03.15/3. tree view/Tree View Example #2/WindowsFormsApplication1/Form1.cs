...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void showCheckedNodesButton_Click(object sender, EventArgs e)
        {
            ...
            // Сворачиваем все узлы дерева - будет вызван обработчик CheckForCheckedChildrenHandler
        ...
        // обработчик события BeforeCollapse сработает только при программном сворачивании узлов
